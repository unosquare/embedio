namespace Unosquare.Labs.EmbedIO.Modules
{
    ...
    /// </summary>
    public class StaticFilesWebModule : WebServerModule
    {
        // TODO: Handle ETags
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StaticFilesWebModule" /> class.
        /// </summary>
        ...
        public StaticFilesWebModule(string fileSystemPath)
            : base()
        {
            ...
            this.AddHandler(WebServerModuleMap.AnyPath, HttpVerbs.Get, (server, context) =>
            {
