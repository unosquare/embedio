namespace Unosquare.Labs.EmbedIO.Modules
{
    ...
    /// </summary>
    public class WebApiModule : WebServerModule
    {
            ...
            : base()
        {
            ...
            this.AddHandler(WebServerModuleMap.AnyPath, HttpVerbs.Any, (server, context) =>
            {
                ...
                var wildcardPaths = DelegateMap.Keys
                    .Where(k => k.EndsWith("/" + WebServerModuleMap.AnyPath))
                ...
                var method = Delegate.CreateDelegate(typeof(WebServerModule.ResponseHandler), controller, methodPair.Item2);
            ...
            where T : WebApiController, new()
        {
            ...
            var protoDelegate = new WebServerModule.ResponseHandler((server, context) => { return true; });
