namespace Unosquare.Labs.EmbedIO.Modules
{
        ...
        : WebModuleBase
    {
        ...
        ///   <paramref name="redirectUrl" /> is not a valid URL.</para>
        /// <para>- or -</para>
        /// <para>
        ///   <paramref name="statusCode" /> is not a redirection (3xx) status code.</para></exception>
        /// <seealso cref="WebModuleBase(string)" />
        public RedirectModule(string redirectUrl, HttpStatusCode statusCode = HttpStatusCode.Found)
            : this(ModuleMap.AnyPath, redirectUrl, null, statusCode, false)
        {
        }
        ...
        ///   <paramref name="redirectUrl" /> is <see langword="null" />.</para>
        /// <para>- or -</para>
        /// <para>
        ///   <paramref name="shouldRedirect" /> is <see langword="null" />.</para></exception>
        /// <exception cref="ArgumentException"><para>
        ///   <paramref name="redirectUrl" /> is not a valid URL.</para>
        /// <para>- or -</para>
        /// <para>
        ///   <paramref name="statusCode" /> is not a redirection (3xx) status code.</para></exception>
        /// <seealso cref="WebModuleBase(string)" />
        public RedirectModule(string url, string redirectUrl, Func<IHttpContext, string, bool> shouldRedirect, HttpStatusCode statusCode = HttpStatusCode.Found)
            : this(url, redirectUrl, shouldRedirect, statusCode, true)
        {
        }
