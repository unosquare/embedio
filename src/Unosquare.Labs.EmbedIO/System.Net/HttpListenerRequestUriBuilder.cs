namespace Unosquare.Net
{
    ...
    internal sealed class HttpListenerRequestUriBuilder
    {
        ...
        {
            return new HttpListenerRequestUriBuilder(
                    rawUri,
                    infoUri.Scheme,
                    infoUri.Authority,
                    infoUri.LocalPath,
        ...
        private ParsingResult BuildRequestUriUsingRawPath(Encoding encoding)
        {
            ...
            _requestUriString = new StringBuilder()
                .Append(_cookedUriScheme)
                .Append(SchemeDelimiter)
                .Append(_cookedUriHost);
        ...
        private bool AppendUnicodeCodePointValuePercentEncoded(string codePoint)
        {
            ...
            if (!int.TryParse(codePoint, NumberStyles.HexNumber, null, out int codePointValue))
            {
                return false;
            }
