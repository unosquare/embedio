...
namespace EmbedIO.Utilities
{
    ...
    public static class StringExtensions
    {
        ...
        /// <seealso cref="SplitByAny(string,StringSplitOptions,char[])"/>
        ...
        /// <param name="delimiters">An array of <see cref="char"/>s to use as delimiters.</param>
        /// <returns>
        /// <para>An array whose elements contain the substrings in <paramref name="this"/> that are delimited
        /// by one or more characters in <paramref name="delimiters"/>.</para>
        ...
        /// <seealso cref="SplitByAny(string,char[])"/>
        public static string[] SplitByAny(this string @this, StringSplitOptions options, params char[] delimiters)
            => @this.Split(delimiters, options);
