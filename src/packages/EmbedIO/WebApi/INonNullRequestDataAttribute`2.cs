...
namespace EmbedIO.WebApi
{
    ...
    /// <para>The difference between this interface and <see cref="IRequestDataAttribute{TController,TData}"/>
    /// is that attributes implementing this interface never retrieve <see langword="null"/> values.</para>
    /// </summary>
